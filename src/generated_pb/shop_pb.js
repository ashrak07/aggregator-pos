...
goog.exportSymbol('proto.shop.ListEventResponse', null, global);
 ...
 * @constructor
 */
proto.shop.ListEventResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.shop.ListEventResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.shop.ListEventResponse.displayName = 'proto.shop.ListEventResponse';
}
 ...
 * @return {!Object}
 */
proto.shop.ListEventResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.shop.ListEventResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.shop.ListEventResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.shop.ListEventResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    events: (f = msg.getEvents()) && event_pb.AllEvents.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.shop.ListEventResponse}
 */
proto.shop.ListEventResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.shop.ListEventResponse;
  return proto.shop.ListEventResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.shop.ListEventResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.shop.ListEventResponse}
 */
proto.shop.ListEventResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new event_pb.AllEvents;
      reader.readMessage(value,event_pb.AllEvents.deserializeBinaryFromReader);
      msg.setEvents(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.shop.ListEventResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.shop.ListEventResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.shop.ListEventResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.shop.ListEventResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEvents();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      event_pb.AllEvents.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional event.AllEvents events = 1;
 * @return {?proto.event.AllEvents}
 */
proto.shop.ListEventResponse.prototype.getEvents = function() {
  return /** @type{?proto.event.AllEvents} */ (
    jspb.Message.getWrapperField(this, event_pb.AllEvents, 1));
};


/**
 * @param {?proto.event.AllEvents|undefined} value
 * @return {!proto.shop.ListEventResponse} returns this
*/
proto.shop.ListEventResponse.prototype.setEvents = function(value) {
 ...
 * @return {!proto.shop.ListEventResponse} returns this
 */
proto.shop.ListEventResponse.prototype.clearEvents = function() {
 ...
 * @return {boolean}
 */
proto.shop.ListEventResponse.prototype.hasEvents = function() {
