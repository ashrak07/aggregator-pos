...
goog.exportSymbol('proto.user.PartnerUsersGroupRequest', null, global);
/**
 ...
 * @constructor
 */
proto.user.PartnerUsersGroupRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.PartnerUsersGroupRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.PartnerUsersGroupRequest.displayName = 'proto.user.PartnerUsersGroupRequest';
}
 ...
 * @return {string}
 */
proto.user.PartnerInformations.prototype.getCountryName = function() {
 ...
 * @return {!proto.user.PartnerInformations} returns this
 */
proto.user.PartnerInformations.prototype.setCountryName = function(value) {
 ...
 * @return {!Object}
 */
proto.user.PartnerUsersGroupRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.user.PartnerUsersGroupRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.PartnerUsersGroupRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.PartnerUsersGroupRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.PartnerUsersGroupRequest}
 */
proto.user.PartnerUsersGroupRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.PartnerUsersGroupRequest;
  return proto.user.PartnerUsersGroupRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.PartnerUsersGroupRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.PartnerUsersGroupRequest}
 */
proto.user.PartnerUsersGroupRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.PartnerUsersGroupRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.PartnerUsersGroupRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.PartnerUsersGroupRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.PartnerUsersGroupRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.user.PartnerUsersGroupRequest.prototype.getGroupUser = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.user.PartnerUsersGroupRequest} returns this
 */
proto.user.PartnerUsersGroupRequest.prototype.setGroupUser = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
