...
goog.exportSymbol('proto.order.OrderPlannerQuery', null, global);
 ...
 * @constructor
 */
proto.order.OrderPlannerQuery = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.order.OrderPlannerQuery, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.order.OrderPlannerQuery.displayName = 'proto.order.OrderPlannerQuery';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.order.OrderPlannerQuery.prototype.toObject = function(opt_includeInstance) {
  return proto.order.OrderPlannerQuery.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.order.OrderPlannerQuery} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.order.OrderPlannerQuery.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.order.OrderPlannerQuery}
 */
proto.order.OrderPlannerQuery.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.order.OrderPlannerQuery;
  return proto.order.OrderPlannerQuery.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.order.OrderPlannerQuery} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.order.OrderPlannerQuery}
 */
proto.order.OrderPlannerQuery.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.order.OrderPlannerQuery.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.order.OrderPlannerQuery.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.order.OrderPlannerQuery} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.order.OrderPlannerQuery.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.order.OrderPlannerQuery.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.order.OrderPlannerQuery} returns this
 */
proto.order.OrderPlannerQuery.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.order.OrderPlannerQuery.prototype.getNb = function() {
 ...
 * @return {!proto.order.OrderPlannerQuery} returns this
 */
proto.order.OrderPlannerQuery.prototype.setNb = function(value) {
 ...
 * @return {number}
 */
proto.order.OrderPlannerQuery.prototype.getPage = function() {
 ...
 * @return {!proto.order.OrderPlannerQuery} returns this
 */
proto.order.OrderPlannerQuery.prototype.setPage = function(value) {
 ...
 * @return {number}
 */
proto.order.OrderQuery.prototype.getCreateUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.order.OrderQuery} returns this
 */
proto.order.OrderQuery.prototype.setCreateUid = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
...
proto.order.Orders.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    shopId: jspb.Message.getFieldWithDefault(msg, 30, 0),
    currencyId: jspb.Message.getFieldWithDefault(msg, 31, 0),
    totalOrder: jspb.Message.getFieldWithDefault(msg, 32, 0)
  };
...
/**
 * optional int32 total_order = 32;
 * @return {number}
 */
proto.order.Orders.prototype.getTotalOrder = function() {
 ...
 * @return {!proto.order.Orders} returns this
 */
proto.order.Orders.prototype.setTotalOrder = function(value) {
